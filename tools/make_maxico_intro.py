# -*- coding: utf-8 -*-
# Maxico1Intro : 마쿠아후이틀 리메이크 인트로. 블렌더 Macuahuitl_INTRO_10_100.blend 10~100 (30fps).
...
FULL = (HI - LO) / FPS
body = [
 "-- %s : 마쿠아후이틀 리메이크(maxico) 인트로. 블렌더 %s %d~%d 프레임 (%dfps)" % (NAME, os.path.basename(BLEND), LO, HI, FPS),
